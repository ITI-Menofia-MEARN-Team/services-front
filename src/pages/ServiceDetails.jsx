...
const ServiceDetails = () => {
  ...
  return (
    <>
      {username && <div className='w-1/2 mx-auto my-5 font-bold text-lg'>
        اسم العميل : {username}
      </div>}
      <div className="flex flex-col lg:flex-row min-h-[90vh]  justify-center ">
        <div className="lg:w-1/2  p-6">
          ...
          <div className="py-4">
            ...
            <strong className="block font-extrabold text-lg text-gray-900 dark:text-gray-100"> اختار خصائص اضافية ؟ </strong>
            <fieldset className="space-y-4">
              <legend className="sr-only">Service</legend>
          ...
          <div className="flex justify-between items-center">
            {(isGuest || isUser) && <div className="flex justify-start items-center gap-4">
              {<button
                onClick={handleOrder}
                disabled={loading}
        ...
        <div className="lg:w-1/2 p-6 min-w-0  rounded-lg shadow-xs ">
          <div className="relative">
            <div>
              <img
                src={`${import.meta.env.VITE_API_BASE_URL}/uploads/service/${service.images?.[currentImageIndex]}`}
                alt="Slider Image"

...
const Card = ({ imageUrl, heading, description }) => {
  return (
    <div className="w-[90%] mx-auto  md:w-[32%] text-center md:text-start px-6 py-4 bg-white rounded-lg dark:bg-gray-900 shadow-xs  text-gray-600 dark:text-gray-400">
